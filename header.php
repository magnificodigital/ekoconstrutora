...
<!--[if gt IE 8]><!--> <html class="no-js" <?php language_attributes(); ?>> <!--<![endif]-->
    ...
    <div class="lightbox">
        ...
        <div class="box-lightbox container">
            <div class="box-light center">
                <span class="close-box"></span>
                <div class="scroll-text swiper-container">
                    <article>
                        <img src="<?php bloginfo('template_url') ?>/images/logo.gif" alt="Eko Construtora" title="Ligue para nós" />
                        <h4>Deseja falar conosco? <span>Ligue para:</span></h4>
                        <p>11. 3090.9702 | 11. 3090.9703<br />
                        11. 3090.9704 | 11. 3090.9705<br />
                        11. 3090.9706</p>
                        <p style="font-style: italic; font-size: 12px; display: block;">* Números provisórios</p>                            
                    </article>
                </div>
            </div>
        </div>
